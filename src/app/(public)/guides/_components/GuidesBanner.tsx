...
export default function GuidesBanner() {
  return (
    <CommonWrapper className="">
      <header className="px-5 md:px-8 lg:px-10 rounded-2xl relative w-full overflow-hidden border border-border bg-linear-to-r from-amber-50/90 via-orange-50/80 to-amber-100/40 dark:from-stone-900/90 dark:via-stone-900/80 dark:to-stone-800/60 h-full">
        <div className="absolute inset-0 z-0 h-full">
          <Image
            ...
            fill
            priority
            className="object-cover object-right opacity-40 h-full sm:opacity-90 lg:opacity-100 dark:opacity-40"
            sizes="100vw"
          />
          {/* Soft gradient mask to guarantee high readability of text on the left */}
          <div className="absolute inset-0 bg-linear-to-r from-amber-50 via-amber-50/85 sm:via-amber-50/60 to-transparent dark:from-stone-900 dark:via-stone-900/90 sm:dark:via-stone-900/70 dark:to-transparent w-full md:w-3/4 lg:w-3/5" />
        </div>
